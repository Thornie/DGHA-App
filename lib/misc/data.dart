...
class Data {
  ...
  static final List<Language> infoLang = <Language>[
    Language(
        ...
        path: "assets/languages/guide_dog_info/english.txt"),
    Language(
        languageName: "French",
        path: "assets/languages/guide_dog_info/french.txt"),
    Language(
        languageName: "Spanish",
        path: "assets/languages/guide_dog_info/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/guide_dog_info/swahilli.txt"),
    Language(
        languageName: "Tagalog",
        path: "assets/languages/guide_dog_info/tagalog.txt"),
  ];
  ...
  static final List<Language> accessLang = <Language>[
    ...
    Language(
        languageName: "French",
        path: "assets/languages/guide_dog_access/french.txt"),
    Language(
        languageName: "Spanish",
  ...
  static final List<Language> fedLang = <Language>[
    Language(
        languageName: "English",
        path: "assets/languages/laws/federal/english.txt"),
    Language(
        languageName: "French",
        path: "assets/languages/laws/federal/french.txt"),
    Language(
        languageName: "Spanish",
        path: "assets/languages/laws/federal/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/federal/swahilli.txt"),
    Language(
        languageName: "Tagalog",
        path: "assets/languages/laws/federal/tagalog.txt"),
  ];

  static final List<Language> actLang = <Language>[
    Language(
        languageName: "English", path: "assets/languages/laws/act/english.txt"),
    Language(
        languageName: "French", path: "assets/languages/laws/act/french.txt"),
    Language(
        languageName: "Spanish", path: "assets/languages/laws/act/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/act/swahilli.txt"),
    Language(
        languageName: "Tagalog", path: "assets/languages/laws/act/tagalog.txt"),
  ];

  static final List<Language> nswLang = <Language>[
    Language(
        languageName: "English", path: "assets/languages/laws/nsw/english.txt"),
    Language(
        languageName: "French", path: "assets/languages/laws/nsw/french.txt"),
    Language(
        languageName: "Spanish", path: "assets/languages/laws/nsw/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/nsw/swahilli.txt"),
    Language(
        languageName: "Tagalog", path: "assets/languages/laws/nsw/tagalog.txt"),
  ];

  static final List<Language> ntLang = <Language>[
    Language(
        languageName: "English", path: "assets/languages/laws/nt/english.txt"),
    Language(
        languageName: "French", path: "assets/languages/laws/nt/french.txt"),
    Language(
        languageName: "Spanish", path: "assets/languages/laws/nt/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/nt/swahilli.txt"),
    Language(
        languageName: "Tagalog", path: "assets/languages/laws/nt/tagalog.txt"),
  ];

  static final List<Language> qldLang = <Language>[
    Language(
        languageName: "English", path: "assets/languages/laws/qld/english.txt"),
    Language(
        languageName: "French", path: "assets/languages/laws/qld/french.txt"),
    Language(
        languageName: "Spanish", path: "assets/languages/laws/qld/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/qld/swahilli.txt"),
    Language(
        languageName: "Tagalog", path: "assets/languages/laws/qld/tagalog.txt"),
  ];

  static final List<Language> saLang = <Language>[
    Language(
        languageName: "English", path: "assets/languages/laws/sa/english.txt"),
    Language(
        languageName: "French", path: "assets/languages/laws/sa/french.txt"),
    Language(
        languageName: "Spanish", path: "assets/languages/laws/sa/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/sa/swahilli.txt"),
    Language(
        languageName: "Tagalog", path: "assets/languages/laws/sa/tagalog.txt"),
  ];

  static final List<Language> tasLang = <Language>[
    Language(
        languageName: "English", path: "assets/languages/laws/tas/english.txt"),
    Language(
        languageName: "French", path: "assets/languages/laws/tas/french.txt"),
    Language(
        languageName: "Spanish", path: "assets/languages/laws/tas/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/tas/swahilli.txt"),
    Language(
        languageName: "Tagalog", path: "assets/languages/laws/tas/tagalog.txt"),
  ];

  static final List<Language> vicLang = <Language>[
    Language(
        languageName: "English", path: "assets/languages/laws/vic/english.txt"),
    Language(
        languageName: "French", path: "assets/languages/laws/vic/french.txt"),
    Language(
        languageName: "Spanish", path: "assets/languages/laws/vic/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/vic/swahilli.txt"),
    Language(
        languageName: "Tagalog", path: "assets/languages/laws/vic/tagalog.txt"),
  ];

  static final List<Language> waLang = <Language>[
    Language(
        languageName: "English", path: "assets/languages/laws/wa/english.txt"),
    Language(
        languageName: "French", path: "assets/languages/laws/wa/french.txt"),
    Language(
        languageName: "Spanish", path: "assets/languages/laws/wa/spanish.txt"),
    Language(
        languageName: "Swahilli",
        path: "assets/languages/laws/wa/swahilli.txt"),
    Language(
        languageName: "Tagalog", path: "assets/languages/laws/wa/tagalog.txt"),
  ];
